...
export default function FeatureListPage() {
  ...
  const { remove, loading: deleteLoading } = useCrud<FeatureMst>(ENDPOINTS.MASTER.FEATURE);
  ...
  return (
    <AdminLayout>
      <PageHeader
        ...
        action={
          <Button onClick={() => router.push('/admin/features/create')}>
            Create Feature
          </Button>
        }
      />
      ...
      <div className="mt-6 space-y-4">
        ...
        <DataTable
          ...
          sortBy={sortBy}
          sortOrder={sortOrder}
          onEdit={(id) => router.push(`/admin/features/${id}/edit`)}
