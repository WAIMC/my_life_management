...
namespace Tests\Feature\Management\CategoryEntryMgmt;
...
class UpdateCategoryEntryMgmtTest extends TestCase
{
  use RefreshDatabase;

  private string $baseUrl = 'api/admin/category-entry-mgmt/update';
  ...
  public function test_CAT_SKL_UPD_005_success_mixed()
  {
    ...
    $entry1 = EntryMgmt::factory()->create();

    $cat2 = CategoryMgmt::factory()->create();
    $entry2 = EntryMgmt::factory()->create();
