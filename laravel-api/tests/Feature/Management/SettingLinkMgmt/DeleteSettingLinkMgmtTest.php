...
class DeleteSettingLinkMgmtTest extends TestCase
{
  ...
  private string $baseUrl = 'api/admin/setting-link-mgmt/delete';
  ...
  public function test_SET_LNK_DEL_001_unauthenticated()
  {
    $response = $this->deleteJson($this->baseUrl . '/1');
    $response->assertStatus(401);
  }

  public function test_SET_LNK_DEL_002_success()
  {
