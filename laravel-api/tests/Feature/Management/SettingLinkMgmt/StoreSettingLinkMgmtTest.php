...
class StoreSettingLinkMgmtTest extends TestCase
{
  use RefreshDatabase;

  private string $baseUrl = 'api/admin/setting-link-mgmt/store';
  ...
  public function test_SET_LNK_STO_001_unauthenticated()
  {
    $response = $this->postJson($this->baseUrl, []);
    $response->assertStatus(401);
  }

  public function test_SET_LNK_STO_002_validation_errors()
  {
  ...
  public function test_SET_LNK_STO_003_success()
  {
    $admin = AdminMst::factory()->create();
    $cookies = $this->getAuthCookies($admin);
