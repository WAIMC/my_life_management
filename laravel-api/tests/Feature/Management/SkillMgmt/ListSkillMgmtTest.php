...
class ListSkillMgmtTest extends TestCase
{
  use RefreshDatabase;

  private string $baseUrl = 'api/admin/skill-mgmt/list';
  ...
  public function test_SKL_LST_002_success_list()
  {
    ...
    SkillMgmt::factory()->count(2)->create();
  ...
  public function test_SKL_LST_003_filter_by_key()
  {
    ...
    SkillMgmt::factory()->create(['name' => 'search_name']);
    SkillMgmt::factory()->create(['name' => 'other_name']);
