...
class DeleteEntryMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/entry-mgmt-hist/delete';
    ...
    public function test_SKL_HST_DEL_001_unauthenticated()
    {
        $response = $this->getJson($this->baseUrl);
        $response->assertStatus(401);
    }

    public function test_SKL_HST_DEL_002_success_list()
    {
    ...
    public function test_SKL_HST_DEL_003_filter_by_desc()
    {
        $admin = AdminMst::factory()->create();
        $cookies = $this->getAuthCookies($admin);
