...
class StoreSkillDescriptionMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/skill-description-mgmt-hist/store';
    ...
    public function test_SKL_DSC_HST_STO_003_filter_by_desc()
    {
        ...
        $response = $this->call('POST', $this->baseUrl, ['skill_description_mgmt_id' => $desc1->id], $cookies);
        $response->assertStatus(200);
