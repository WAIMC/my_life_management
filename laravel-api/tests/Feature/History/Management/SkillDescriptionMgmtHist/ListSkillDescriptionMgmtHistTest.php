...
class ListSkillDescriptionMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/skill-description-mgmt-hist/list';
    ...
    public function test_SKL_DSC_HST_LST_003_filter_by_desc()
    {
        ...
        $response = $this->call('GET', $this->baseUrl, ['skill_description_mgmt_id' => $desc1->id], $cookies);
        $response->assertStatus(200);
