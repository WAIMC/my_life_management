...
class StoreEntryDescriptionMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/entry-description-mgmt-hist/store';
    ...
    public function test_SKL_DSC_HST_STO_001_unauthenticated()
    {
        $response = $this->getJson($this->baseUrl);
        $response->assertStatus(401);
    }

    public function test_SKL_DSC_HST_STO_002_success_list()
    {
    ...
    public function test_SKL_DSC_HST_STO_003_filter_by_desc()
    {
        $admin = AdminMst::factory()->create();
        $cookies = $this->getAuthCookies($admin);
