...
class ListEntryDescriptionMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/entry-description-mgmt-hist/list';
    ...
    public function test_SKL_DSC_HST_LST_001_unauthenticated()
    {
        $response = $this->getJson($this->baseUrl);
        $response->assertStatus(401);
    }

    public function test_SKL_DSC_HST_LST_002_success_list()
    {
    ...
    public function test_SKL_DSC_HST_LST_003_filter_by_desc()
    {
        $admin = AdminMst::factory()->create();
        $cookies = $this->getAuthCookies($admin);
        ...
        $response = $this->call('GET', $this->baseUrl, ['entry_description_mgmt_id' => $desc1->id], $cookies);
        $response->assertStatus(200);
