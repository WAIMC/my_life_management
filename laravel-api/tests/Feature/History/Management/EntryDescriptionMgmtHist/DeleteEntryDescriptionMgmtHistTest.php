...
class DeleteEntryDescriptionMgmtHistTest extends TestCase
{
    use RefreshDatabase;

    private string $baseUrl = 'api/admin/entry-description-mgmt-hist/delete';
    ...
    public function test_SKL_DSC_HST_DEL_003_filter_by_desc()
    {
        ...
        $response = $this->call('DELETE', $this->baseUrl, ['entry_description_mgmt_id' => $desc1->id], $cookies);
        $response->assertStatus(200);
