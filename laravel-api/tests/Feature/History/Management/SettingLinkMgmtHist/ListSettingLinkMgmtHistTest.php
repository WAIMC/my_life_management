...
class ListSettingLinkMgmtHistTest extends TestCase
{
  ...
  public function test_SET_LNK_HST_LST_001_unauthenticated()
  {
    $response = $this->getJson($this->baseUrl);
    $response->assertStatus(401);
  }

  public function test_SET_LNK_HST_LST_002_success_list()
  {
  ...
  public function test_SET_LNK_HST_LST_003_filter_by_setting()
  {
    $admin = AdminMst::factory()->create();
    $cookies = $this->getAuthCookies($admin);
