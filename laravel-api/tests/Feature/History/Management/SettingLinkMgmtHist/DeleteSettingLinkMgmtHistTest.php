...
class DeleteSettingLinkMgmtHistTest extends TestCase
{
  use RefreshDatabase;

  private string $baseUrl = 'api/admin/setting-link-mgmt-hist/delete';
  ...
  public function test_SET_LNK_HST_DEL_002_success()
  {
