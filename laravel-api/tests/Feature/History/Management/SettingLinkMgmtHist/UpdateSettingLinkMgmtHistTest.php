...
class UpdateSettingLinkMgmtHistTest extends TestCase
{
  use RefreshDatabase;

  private string $baseUrl = 'api/admin/setting-link-mgmt-hist/update';
  ...
  public function test_SET_LNK_HST_UPD_001_unauthenticated()
  {
    $response = $this->putJson($this->baseUrl . '/1', []);
    $response->assertStatus(401);
  }

  public function test_SET_LNK_HST_UPD_002_validation_errors()
  {
    $admin = AdminMst::factory()->create();
    $cookies = $this->getAuthCookies($admin);
    $setting = SettingLinkMgmt::factory()->create();

    $hist = SettingLinkMgmtHist::create([
  ...
  public function test_SET_LNK_HST_UPD_003_success()
  {
    $admin = AdminMst::factory()->create();
    $cookies = $this->getAuthCookies($admin);
    $setting = SettingLinkMgmt::factory()->create();
