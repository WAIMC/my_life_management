...
class RoleMstListRequest extends FormRequest
{
  /**
  ...
  public function messages(): array
  {
    return [
      ...
      'name.string' => Messages::getMessage(
        Messages::E0002,
        ['attributes' => RoleMst::attributes()['name']]
      ),
      'name.min' => Messages::getMessage(
        Messages::E0010,
        [
          'attributes' => RoleMst::attributes()['name'],
          'number' => RoleMst::LENGTH_ATTR[0]
        ]
      ),
      ...
      'permission.string' => Messages::getMessage(
        Messages::E0002,
        ['attributes' => RoleMst::attributes()['permission']]
      ),
      ...
      'is_active.bool' => Messages::getMessage(
        Messages::E0005,
        ['attributes' => RoleMst::attributes()['is_active']]
      ),
