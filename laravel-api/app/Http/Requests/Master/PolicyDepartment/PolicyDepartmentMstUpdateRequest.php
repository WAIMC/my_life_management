...
class PolicyDepartmentMstUpdateRequest extends FormRequest
{
  /**
  ...
  public function messages(): array
  {
    return [
      ...
      'table_name.string' => Messages::getMessage(
        Messages::E0002,
        ['attributes' => PolicyDepartmentMst::attributes()['table_name']]
      ),
      'table_name.min' => Messages::getMessage(
        Messages::E0010,
        [
          'attributes' => PolicyDepartmentMst::attributes()['table_name'],
          'number' => PolicyDepartmentMst::LENGTH_ATTR[0]
        ]
      ),
      'table_name.max' => Messages::getMessage(
        ...
        [
          'attributes' => PolicyDepartmentMst::attributes()['table_name'],
          'number' => PolicyDepartmentMst::LENGTH_ATTR[20]
        ]
      ),
      ...
      'row_id.numeric' => Messages::getMessage(
        Messages::E0001,
        ['attributes' => PolicyDepartmentMst::attributes()['row_id']]
      ),
