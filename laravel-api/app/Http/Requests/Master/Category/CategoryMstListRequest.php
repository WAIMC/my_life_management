...
class CategoryMstListRequest extends FormRequest
{
  /**
  ...
  public function rules(): array
  {
    return [
      ...
      'status'      => 'in:' . implode(',', array_keys(CategoryMgmt::CATEGORY_STATUS)),
    ...
    return [
      ...
      'status.in' => Messages::getMessage(
        ...
        [
          ...
          'range' => implode(',', array_keys(CategoryMgmt::CATEGORY_STATUS))
        ]
      ),
