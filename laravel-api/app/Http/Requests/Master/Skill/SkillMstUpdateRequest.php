...
class SkillMstUpdateRequest extends FormRequest
{
  /**
  ...
  public function rules(): array
  {
    ...
    return [
      ...
      'name'        => ['string', 'min:0', 'max:50', Rule::unique(SkillMgmt::class)->ignore($params['id'])],
      'slug'        => ['string', 'min:0', 'max:50', Rule::unique(SkillMgmt::class)->ignore($params['id'])],
