...
class ApiMstListRequest extends FormRequest
{
  /**
  ...
  {
    return [
      'type'       => 'in:' . implode(',', array_keys(ApiMst::TYPE_OF_METHOD)),
  ...
  public function messages(): array
  {
    return [
      ...
      'type.in' => Messages::getMessage(
        Messages::E0015,
        [
          'attributes' => ApiMst::attributes()['type'],
          'range' => implode(',', array_keys(ApiMst::TYPE_OF_METHOD))
        ]
      ),
      ...
      'name.string' => Messages::getMessage(
        Messages::E0002,
        ['attributes' => ApiMst::attributes()['name']]
      ),
      'name.min' => Messages::getMessage(
        Messages::E0010,
        [
          'attributes' => ApiMst::attributes()['name'],
          'number' => ApiMst::LENGTH_ATTR[0]
        ]
      ),
      ...
      'path.string' => Messages::getMessage(
        Messages::E0002,
        ['attributes' => ApiMst::attributes()['path']]
      ),
      ...
      'is_active.in' => Messages::getMessage(
        Messages::E0005,
        ['attributes' => ApiMst::attributes()['is_active']]
      ),
      ...
      'feature_id.integer' => Messages::getMessage(
        Messages::E0001,
        ['attributes' => ApiMst::attributes()['feature_id']]
      ),
