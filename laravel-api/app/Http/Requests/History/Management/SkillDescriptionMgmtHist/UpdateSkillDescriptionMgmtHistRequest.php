...
class UpdateSkillDescriptionMgmtHistRequest extends BaseFormRequest
{
    /**
    ...
    {
        return [
            'id' => ['required', 'integer', 'min:1', Rule::exists(SkillDescriptionMgmtHist::class, 'id')],
            'skill_description_mgmt_id' => ['required', 'integer', 'min:' . CommonVal::MIN_INTEGER, 'max:' . CommonVal::MAX_INTEGER, Rule::exists(SkillDescriptionMgmt::class, 'id'),],
            ...
            'rank_order' => [],
            'skill_id' => ['integer', 'min:' . CommonVal::MIN_INTEGER, 'max:' . CommonVal::MAX_INTEGER,],
            'action' => ['required',],
