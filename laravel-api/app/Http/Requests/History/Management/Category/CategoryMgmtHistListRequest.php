...
class CategoryMgmtHistListRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'category_mgmt_id' => 'nullable|integer|exists:category_mgmt,id',
            ...
            'sort_by' => 'nullable|string|in:id,category_mgmt_id,action,created_at',
