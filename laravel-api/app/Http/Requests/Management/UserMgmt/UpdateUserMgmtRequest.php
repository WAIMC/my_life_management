...
class UpdateUserMgmtRequest extends BaseFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => ['required', 'email:rfc,dns', 'min:' . CommonVal::MIN_VARCHAR, 'max:' . CommonVal::MAX_EMAIL, Rule::unique(UserMgmt::class, 'email'),],
