...
class CategoryMstController extends Controller
{
  ...
  public function list(Request $request): Response
  {
    return $this->handleRequest(function () use ($request) {
      ...
      return CategoryMgmtService::getInstance()->list($payload);
    });
  }
  ...
  public function store(Request $request): Response
  {
    return $this->handleRequest(function () use ($request) {
      ...
      return CategoryMgmtService::getInstance()->store($payload);
    });
  }
  ...
  public function update(Request $request, string $id): Response
  {
    return $this->handleRequest(function () use ($request, $id) {
      ...
      return CategoryMgmtService::getInstance()->update($payload);
    });
  }
  ...
  public function delete(Request $request, string $id): Response
  {
    return $this->handleRequest(function () use ($request, $id) {
      ...
      return CategoryMgmtService::getInstance()->delete($id);
    });
  }
}
