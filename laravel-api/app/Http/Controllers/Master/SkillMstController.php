...
use App\Services\Master\SkillMstService;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\Routing\Exception\MethodNotAllowedException;

class SkillMstController extends Controller
{
  /**
   * SkillMgmt list
   *
  ...
  public function list(Request $request): Response
  {
    return $this->handleRequest(function () use ($request) {
      ...
      return SkillMstService::getInstance()->list($payload);
    });
  }
  ...
  public function store(Request $request): Response
  {
    return $this->handleRequest(function () use ($request) {
      ...
      return SkillMstService::getInstance()->store($payload);
    });
  }
  ...
  public function update(Request $request, string $id): Response
  {
    return $this->handleRequest(function () use ($request, $id) {
      ...
      return SkillMstService::getInstance()->update($payload);
    });
  }
  ...
  public function delete(Request $request, string $id): Response
  {
    return $this->handleRequest(function () use ($request, $id) {
      ...
      return SkillMstService::getInstance()->delete($id);
    });
  }
}
